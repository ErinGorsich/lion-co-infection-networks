...
##################################################
pall<- read.csv("~/Documents/postdoc_buffology/HB-lion_coinfection_network/net_stats_allparasitenetwork.csv")
pneg<- read.csv("~/Documents/postdoc_buffology/HB-lion_coinfection_network/net_stats_FIVnegparasitenetwork.csv")
ppos<- read.csv("~/Documents/postdoc_buffology/HB-lion_coinfection_network/net_stats_FIVposparasitenetwork.csv")
...
##################################################
lall<-read.csv("~/Documents/postdoc_buffology/HB-lion_coinfection_network/net_stats_alllionnetwork.csv")
lneg<-read.csv("~/Documents/postdoc_buffology/HB-lion_coinfection_network/net_stats_FIVneglionnetwork.csv")
lpos<-read.csv("~/Documents/postdoc_buffology/HB-lion_coinfection_network/net_stats_FIVposlionnetwork.csv")
...
* Mean Degree (Weighted): the average number of shared hosts per pathogen.  
* Diameter: The maximum number of steps in the set of shortest paths between all parasite pairs.  This is a measure of connectedness- if you are one parasite, how quickly can you get to all the others) .
...
##################################################
##################################################
#make_bipart_hive_plot(FIVpos_binet, datatype="FIV", demogdata=alldata, 
